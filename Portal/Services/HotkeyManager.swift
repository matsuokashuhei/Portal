...
final class HotkeyManager {
    ...
    /// Checks if the hotkey should be skipped for the current context.
    ///
    /// This method checks two conditions:
    /// 1. Whether the frontmost application is in the exclusion list
    /// 2. Whether a text input element currently has focus
    ///
