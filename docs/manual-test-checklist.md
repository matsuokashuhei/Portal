...
## 7. セグメントコントロール・ツールバーテスト

### 7.1 セグメントコントロール検出 (Find My)

- [ ] Find My.appを開く
- [ ] Option+Spaceでコマンドパレットを表示
- [ ] "People", "Devices", "Items" がサイドバーアイテムとして表示される
- [ ] Sidebarフィルタ(Cmd+2)でセグメントが表示される
- [ ] セグメントを選択・実行するとFind Myの表示が切り替わる

### 7.2 ツールバーボタン検出 (Find My)

- [ ] Find My.appを開く
- [ ] Option+Spaceでコマンドパレットを表示
- [ ] "+" ボタン（Add）がアイテムとして表示される
- [ ] ボタンを選択・実行すると追加ダイアログが開く
